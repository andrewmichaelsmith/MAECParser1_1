...
public class Block {
    ...
    public static class Images {
        ...
        public static class Image {
            ...
            @XmlElementRefs({
                @XmlElementRef(name = "Image_Location", namespace = "http://maec.mitre.org/XMLSchema/maec-core-1", type = JAXBElement.class),
                @XmlElementRef(name = "Image_Title", namespace = "http://maec.mitre.org/XMLSchema/maec-core-1", type = JAXBElement.class)
            })
